...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager securityManager) {
        ...
        bean.setUnauthorizedUrl("/unauthorized");//提供权限不足的url
        /*
        ...
        filterChainDefinitionMap.put("/login", "anon");//配置不会被拦截的路径
        filterChainDefinitionMap.put("/loginUser", "anon");//配置不会被拦截的路径
